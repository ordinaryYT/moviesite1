// server.js - 100% COMPLETE FINAL VERSION - ONLY YOUR SUBTITLES IN VIDSRCS PLAYER
...
function generateCode(prefix = 'om-') {
  return prefix + Math.random().toString(36).substr(2, 12).toUpperCase(); // FIXED
}
...
server.listen(PORT, () => {
  ...
  console.log(`ONLY YOUR CLEAN SUBTITLES SHOW IN PLAYER - NO VIDSRCS SUBS - NO PROMO LINES - 100% WORKING`);
});
