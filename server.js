...
// ====================== FINAL EMBED - ONLY YOUR SUBTITLES ======================
app.get('/api/movies/:id/embed', authMiddleware, async (req,res) => {
  ...
  // OFFICIAL VIDSR.TO SINGLE-FILE METHOD
...
server.listen(PORT, () => {
  ...
  console.log(`ONLY YOUR CLEAN ENGLISH SUBTITLES SHOW IN VIDSR.TO PLAYER - 100% WORKING NOV 18 2025`);
});
